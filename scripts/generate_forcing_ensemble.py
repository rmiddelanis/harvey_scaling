...
if __name__ == "__main__":
    ...
    parser.add_argument('--econ_baseyear', type=int, default=2015, help='')
    parser.add_argument('--ensemble_dir', type=str,
                        default=os.path.join(home_dir, 'repos/harvey_scaling/data/acclimate_forcing/main_analysis/'), help='')
    ...
    parser.add_argument('--cc_factor', type=float, default=1.19, help='')
    ...
    parser.add_argument('--old_output', action='store_true')
    pars = vars(parser.parse_args())

    if not pars['old_output']:
        settings_tpl_path = os.path.join(home_dir, 'repos/harvey_scaling/data/acclimate_forcing/main_analysis/settings_template.yml')
    else:
        settings_tpl_path = os.path.join(home_dir, 'repos/harvey_scaling/data/acclimate_forcing/main_analysis/settings_template_old_output.yml')
    ...
    if pars['old_output']:
        ensemble_dir_path += "__old_output"
